...
var relay = createServer({
  ...
  onCreateWorktree: function (parentSlug, branchName, dirName, baseBranch, existingBranch) {
    ...
    var result = createWorktree(parent.path, branchName, dirName, baseBranch, existingBranch);
