...
(function ensurePackageReadable() {
  try {
    ...
    // (e.g. /root/.npm/_npx/.../node_modules/@hlouis/clay needs /root to be o+x)
    ...
    // parent node_modules/ instead of inside @hlouis/clay/node_modules/.
    var { execSync: chmodExec } = require("child_process");
    // Find the top-level node_modules that contains @hlouis/clay
