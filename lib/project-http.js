    ...
    if (req.method === "GET" && (urlPath === "/api/file-preview" || urlPath.indexOf("/api/file-preview/") === 0)) {
      ...
      try {
        ...
        res.writeHead(200, {
          ...
          "Content-Security-Policy": "sandbox; default-src 'none'; img-src 'self' data: blob:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; media-src 'self'; frame-ancestors 'self'",
        });
